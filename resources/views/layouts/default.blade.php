...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{route('polindromo.index')}}">
            <i class="fa fa-calendar"></i> <span>Palindromo</span>
          </a>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="#">Fernanda Cruz Quintero</a>.</strong> All rights reserved.
  </footer>
